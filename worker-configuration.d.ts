/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: eed84ccc55c7800fe2cb85d9426c3d3e)
// Runtime types generated with workerd@1.20260329.1 2025-03-10 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DiscogsMCP";
	}
	interface Env {
		OAUTH_KV: KVNamespace;
		DISCOGS_TOKEN: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").DiscogsMCP>;
	}
}
